...
import net.mtm101.tinkeringwcreate.registers.ModSpriteShifts;

public class SmelteryTankModel extends CTModel {

    protected static final ModelProperty<CullData> CULL_PROPERTY = new ModelProperty<>();

    public static SmelteryTankModel standard(BakedModel originalModel) {
        return new SmelteryTankModel(originalModel, ModSpriteShifts.SMELTERY_TANK, ModSpriteShifts.SMELTERY_TANK_TOP,
                ModSpriteShifts.SMELTERY_TANK_INNER);
    }

    private SmelteryTankModel(BakedModel originalModel, CTSpriteShiftEntry side, CTSpriteShiftEntry top,
