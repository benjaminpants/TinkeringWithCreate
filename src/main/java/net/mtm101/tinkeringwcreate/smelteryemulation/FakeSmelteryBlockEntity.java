...
public class FakeSmelteryBlockEntity extends SmelteryBlockEntity implements IFakeSmeltery
{
    ...
    public FakeSmelteryBlockEntity(SmelteryTankBlockEntity myParent) {
    ...
    public FakeSmelteryBlockEntity(BlockPos pos, BlockState state) throws Exception {
        super(pos, state);
        throw new Exception("Attempted to use FakeSmelteryBlockEntity as actual block entity!");
    }
